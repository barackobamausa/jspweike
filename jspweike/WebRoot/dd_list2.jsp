...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td width="138" align="center" bgcolor="CCFFFF">接受人</td>
    <td width="138" align="center" bgcolor="CCFFFF">接受时间</td>
    
    <td width="60" align="center" bgcolor="CCFFFF">同意</td>
    <td width="60" align="center" bgcolor="CCFFFF">操作</td>
  </tr>
  <%
  String sql="";
  sql="select * from gwc where faburen='"+request.getSession().getAttribute("username")+"'";
 ...
 String addtime=""; String yonghuming="";String issh="";
 int i=0;
...
renwumingcheng=RS_result.getString("renwumingcheng");leibie=RS_result.getString("leibie");wanchengshixian=RS_result.getString("wanchengshixian");zhifubaochou=RS_result.getString("zhifubaochou");
 addtime=RS_result.getString("addtime"); yonghuming=RS_result.getString("yonghuming");issh=RS_result.getString("issh");
 
 
%>
  <tr>
    <td width="30" align="center"><%=i %></td>
    <td><%=renwumingcheng %></td><td><%=leibie %></td><td><%=wanchengshixian %></td><td><%=zhifubaochou %></td>
    <td width="138" align="center"><%=yonghuming %></td>
    <td width="138" align="center"><%=addtime %></td>
    <td width="60" align="center"><a href="sh.jsp?id=<%=id%>&yuan=<%=issh%>"><%=issh%></a></td>
    <td width="60" align="center"><a href="faburenwu_updt.jsp?id=<%=id%>"></a>  <a href="del.jsp?id=<%=id %>&tablename=faburenwu" onClick="return confirm('真的要删除？')">删除</a></td>
  </tr>
  	<%
  }
   %>
