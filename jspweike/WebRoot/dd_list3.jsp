...
%>
  <tr>
    ...
    <td width="60" align="center"><%=yonghuming %></td>
    <td width="60" align="center"><%=issh%></td>
    <td width="60" align="center"><a href="faburenwu_updt.jsp?id=<%=id%>"></a>  <a href="del.jsp?id=<%=id %>&tablename=gwc" onClick="return confirm('真的要删除？')">删除</a></td>
  </tr>
  	<%
  }
   %>
