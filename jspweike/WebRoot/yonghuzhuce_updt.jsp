...
function check()
{
  ...
  jb=RS_result.getString("jb");  yonghuming=RS_result.getString("yonghuming");mima=RS_result.getString("mima");xingming=RS_result.getString("xingming");xingbie=RS_result.getString("xingbie");dianhua=RS_result.getString("dianhua");QQ=RS_result.getString("QQ");youxiang=RS_result.getString("youxiang");chushengnianyue=RS_result.getString("chushengnianyue");touxiang=RS_result.getString("touxiang");dizhi=RS_result.getString("dizhi");
  }
   %>
