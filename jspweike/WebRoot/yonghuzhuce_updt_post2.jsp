...
String sql="update yonghuzhuce set yonghuming='"+yonghuming+"',mima='"+mima+"',xingming='"+xingming+"',xingbie='"+xingbie+"',dianhua='"+dianhua+"',QQ='"+QQ+"',youxiang='"+youxiang+"',chushengnianyue='"+chushengnianyue+"',touxiang='"+touxiang+"',dizhi='"+dizhi+"' where yonghuming= '"+request.getSession().getAttribute("username")+"'";
